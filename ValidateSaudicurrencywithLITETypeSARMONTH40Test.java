...
import java.net.URL;
public class ValidateSaudicurrencywithLITETypeSARMONTH40Test {
  ...
  @Test
  public void validateSaudicurrencywithLITETypeSARMONTH40() {
    ...
    driver.findElement(By.cssSelector("#SHAHID_PLUS_SUBSCRIPTION > .payment-body")).click();
